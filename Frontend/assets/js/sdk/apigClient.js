...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://35nkz9jx1b.execute-api.us-east-1.amazonaws.com/dev-stage';
    ...
    apigClient.resultsGet = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        
        apiGateway.core.utils.assertParametersDefined(params, [], ['body']);
        
        var resultsGetRequest = {
            verb: 'get'.toUpperCase(),
            path: pathComponent + uritemplate('/results').expand(apiGateway.core.utils.parseParametersToObject(params, [])),
        ...
        return apiGatewayClient.makeRequest(resultsGetRequest, authType, additionalParams, config.apiKey);
    };
    
    
    apigClient.resultsOptions = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        
        apiGateway.core.utils.assertParametersDefined(params, [], ['body']);
        
        var resultsOptionsRequest = {
        ...
        return apiGatewayClient.makeRequest(resultsOptionsRequest, authType, additionalParams, config.apiKey);
    };
